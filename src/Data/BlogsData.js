...
export const BlogsData = {
    ...
    seo: {
        title: "Professional Google Business Profile management services",
        metaDescription: "Boost your local visibility with professional Google Business Profile management services. Optimize listings, improve rankings, manage reviews, and attract more customers to grow your business."
    },

    // The Intro Text (From your first screenshot)
    intro: {
    ...
    // The Main Article Content (From your second screenshot)
    article: {
        heading: "Improve Rankings with Google Business Profile management services",

      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="md:col-span-6 lg:col-span-4 flex flex-col">
            ...
            <div className="flex items-center gap-3">
              {/* Instagram */}
              <a href="#" className="flex justify-center items-center w-10 h-10 rounded-full bg-white/5 border border-white/10 text-white hover:bg-[#1a6b8f] hover:border-[#1a6b8f] hover:-translate-y-1 transition-all duration-300 shadow-lg">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm font-medium text-slate-500">
            <a href="#" className="hover:text-[#36b5cc] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#36b5cc] transition-colors">Terms of Service</a>
          </div>
        </div>

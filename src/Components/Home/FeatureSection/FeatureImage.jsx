...
const FeatureImage = () => {
  return (
    <div className="relative group w-full">
      ...
      <div className="relative rounded-xl overflow-hidden shadow-[0_20px_50px_-5px_rgba(0,0,0,0.3)] border border-gray-100 bg-white transition-transform duration-500 ">
        <img
          src={featureImage}
          alt="Google Profile Optimization for Local SEO"
